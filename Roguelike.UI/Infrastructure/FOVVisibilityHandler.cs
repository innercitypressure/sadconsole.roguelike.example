...
public class FOVVisibilityHandler : FOVHandler
{
   private readonly int _ghostLayer;
    ...
    public FOVVisibilityHandler(Map map, Color unexploredColor, int ghostLayer,
    ...
    public void RefreshExploredTerrain()
    {
        for (int x = 0; x < Map.Width; x++)
        {
            for (int y = 0; y < Map.Height; y++)
            {
                ...
                {
                    BaseTile tile = Map.Terrain[x, y] as BaseTile;
    ...
    protected override void UpdateTerrainSeen(BaseTile terrain)
    {
    ...
    /// </summary>
    /// <param name="terrain">Terrain to modify.</param>
    protected override void UpdateTerrainUnseen(BaseTile terrain)
    {
    ...
    private void ApplyMemoryAppearance(BaseTile tile)
    {
